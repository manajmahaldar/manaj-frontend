        ...
        <div className="pb-20 bg-gray-50/30 min-h-screen">
            ...
            {loading && posts.length === 0 ? (
                ...
                <div className="space-y-12">
                    <div className={`flex overflow-x-auto gap-6 pb-4 snap-x snap-mandatory scrollbar-hide md:grid md:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:overflow-visible w-full transition-opacity duration-200 ${loading ? 'opacity-70' : 'opacity-100'}`}>
                        {posts.map(post => (
